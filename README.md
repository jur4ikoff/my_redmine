...
## Интерфейс
Взаимодействие с пользователем будет происходить через WEB MPA

## Стек
**frontend:** typesctipt + (react)  
**backend:** python
- fastapi
- pydantic + mypy
- pytest
...
## Диаграмма C4
### Уровень 1
На этапе MVP микросервисная архитектура не рассматривается. Акторы взаимодействуют с единой системой  
![alt text](docs/diag/PPO/C4-l1.png)

### Уровень 2
Приложение состоит из 4 контейенеров  
![alt text](docs/diag/PPO/C4-l2.png)

### Уровень 3
На этапе MVP было решено смежную функциональность объединить в один сервис, например настройку кастомных полей, кастомных значений и workflow
![alt text](docs/diag/PPO/C4-l3.png)
